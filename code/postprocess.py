...
def figure1(
    ...
    assert np.isclose(results[0].v.max(), 1.1020528, rtol=1e-4), results[0].v.max()
    assert np.isclose(results[0].w.max(), 0.6689413, rtol=1e-4), results[0].w.max()
...
def table1(results: list[Result], outfile: Path):
    ...
    assert np.isclose(data[0]["APD50 (V)"], 26.620362, rtol=1e-4), data[0]["APD50 (V)"]
    assert np.isclose(data[0]["APD50 (W)"], 27.078644, rtol=1e-4), data[0]["APD50 (W)"]

    assert np.isclose(data[1]["APD50 (V)"], 27.658528, rtol=1e-4), data[1]["APD50 (V)"]
    assert np.isclose(data[1]["APD50 (W)"], 28.013365, rtol=1e-4), data[1]["APD50 (W)"]
